...
#ifndef GALAXY
// [[Rcpp::export]]
int IRF_main_debug(std::string bam_file, std::string reference_file, std::string output_file, bool verbose = true){
  
  std::string s_output_txt = output_file + ".txt.gz";
  std::string s_output_cov = output_file + ".cov";
#else
int IRF_main_debug(std::string bam_file, std::string reference_file, std::string s_output_txt, std::string s_output_cov){	
	bool verbose = true;
#endif
  ...
  inCoverageBlocks.str(myBuffer);
  CoverageBlocksIRFinder * oCoverageBlocks;
  oCoverageBlocks = new CoverageBlocksIRFinder;
  oCoverageBlocks->loadRef(inCoverageBlocks);
